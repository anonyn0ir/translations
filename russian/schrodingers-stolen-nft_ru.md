...
> [_Robin (SuperMassive):_](https://twitter.com/DirSchmidt)_ In essence this is the _[_prisoner's dilemma._](https://en.wikipedia.org/wiki/Prisoner%27s_dilemma)_ The best outcome for all owners is NOT to look inside._

But what if you didn’t need to look inside?

**What if one player could break the rules and choose where the NFT was placed?**
