...
**_“При нормальном развитии событий случилось бы следующее. Подана заявка на вывод и средства выплачены казне Armor. Однако мы констатируем, что в результате этой хакерской атаки на arCore Protect пользователи не понесли материальных потерь. Armor обязан принять оптимальное и справедливое решение для протокола и сообщества. Поэтому Armor подаст заявку на выплату и использует ее в качестве страховки для стакеров хранилища доходности arNXM.”_**
